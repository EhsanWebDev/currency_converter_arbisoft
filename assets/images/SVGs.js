...
import Svg, { Circle, Path, SvgUri, SvgXml } from "react-native-svg"
import { colors } from '../../src/constants/colors';

const SvgComponent = ({ isDark }) => (
    <Svg width={160} height={160} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <Circle

            fill={isDark ? colors.mid_purple : colors.sky}
            cx={18} cy={18} r={15} />
        <Path

            fill={isDark ? colors.light_green : colors.green}
